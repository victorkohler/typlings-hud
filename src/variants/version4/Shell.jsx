...
// Version 4 — version2's 5-tab HUD (Details as the last tab) combined with
// version3's full-screen cart panel. Size/frame can be configured both from
// the Details tab *and* from inside the cart panel, so the user gets a final
// chance to tweak options without leaving the confirm flow.
